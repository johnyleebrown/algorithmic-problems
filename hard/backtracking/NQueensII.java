...
public class NQueensII
{
	 ...
	 * using 3 sets: diag1, diag2, cols to keep track of seen cells
	 * no need to keep track of rows cuz we think we are on the right row every time
	 *
	 * O(n!) / O(n)
	 *
	...
	class Solution {
		...
		private void findSolutions(int n, int i)
		{
			for (int j = 0; j < n; j++)
			{
				...
				int diag1 = i - j; if (diags1.contains(diag1)) continue;
				int diag2 = i + j; if (diags2.contains(diag2)) continue;

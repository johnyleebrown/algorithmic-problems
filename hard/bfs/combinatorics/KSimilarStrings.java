...
public class KSimilarStrings
{
     ...
     *
     * time complexity
     * for the result case we will have n permutations, this means that for others is always < n.
     * overall -> O(n).
     *
     * the idea here is to find the chars in string polled from queue that match the char on position in i from target string.
     * this way we are finding the right spots for each char.
     * and we don't want to touch the chars that are already aligned with B.
     */
    class Solution
    {

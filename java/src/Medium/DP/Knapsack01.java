...
public class Knapsack01 {
    class Solution {
         ...
         * @param cap knapsack capacity
         * @return maximum value of items
         */
        public int Knapsack01(int[] values, int[] weights, int cap) {
            /**
             * Algorithm:
             ...
             */
            int i, w;
            int k[][] = new int[values.length + 1][weights.length + 1];

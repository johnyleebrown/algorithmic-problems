...
public class SortArrayOfSortedArrays
{
	/*
	 * Use pq
	 * O(n*m) + O(n*m*log(n*m)) + O(n*m*log(n*m)) 
	 */
	...
	/*
	 * Iterate through ar, swap with smallest number from lower rows.
	 * Place the element in the lowest row in the right position.
	 * Complexity: need to go through m*n/2 cells apprx + sort and swaps will take n/2*m^2.
	 */

...
def add_package_info_if_needed(path, new_data):
    eliminate_path_for_pckg = '/Volumes/Greg/projects/algorithmic-problems/src'
...
def get_template(new_file_name):
    script_path = '/Volumes/Greg/projects/algorithmic-problems/other/scripts/create_solution/template'

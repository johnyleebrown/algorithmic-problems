...
public class EditDistance
{
	...
	public static class Solution
	{
		...
		public int minDistance(String w1, String w2)
		{
			...
			return dfs(nw1, nw2, w1, w2);
		}

		int dfs(int i1, int i2, String w1, String w2)
		{
			if (i1 > w1.length())
				return w2.length() - i2;
			if (i2 > w2.length())
			...
			{
				dp[i1][i2] = dfs(i1 - 1, i2 - 1, w1, w2);
			}
			else
			{
				dp[i1][i2] = Math.min(Math.min(dfs(i1, i2 - 1, w1, w2), dfs(i1 - 1, i2, w1, w2)), dfs(i1 - 1, i2 - 1, w1, w2)) + 1;
			}
			return dp[i1][i2];
		}
	}

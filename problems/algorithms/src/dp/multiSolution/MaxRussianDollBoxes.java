 ...
 * Task.
 *
 * Given a collection of boxes. Return the max number of boxes that you can
 * russian doll. Each box has (w, h, l).
 *
 * ======
 *
 * Source: Leetcode
...
//            }
    ...
    public static class SolutionAgainst implements Solution {
        ...
        public int solve(int[][] a) {
            int res = 1;
            Arrays.sort(a, (e1, e2) -> e1[0] == e2[0] ? e1[1] == e2[1] ? e1[2] - e2[2] : e1[1] - e2[1] : e1[0] - e2[0]);

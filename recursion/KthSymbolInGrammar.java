...
public class KthSymbolInGrammar
{
    class Solution {
        /**
         Using recursion go to the first node to find out what it is
         Every time knowing a parent and current K we can calculate current value
        ...
        {
            if ((parent == 0 && K % 2 == 1) || (parent == 1 && K % 2 == 0)) return 0;

...
public class CombinationSum {
	/**
	 * loop over one number over and over until the sum is target then append
	 * other numbers use start so not to stumblr upon dups sort and check the
	 * prev if equals for optimization
	 *
	 * O(n! + nlogn)
	 */
	class Solution {

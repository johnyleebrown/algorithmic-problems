...
public class JumpGameV {
  ...
  /**
   * Straightforward. Similar to frog jump, either we jump to position (+1) and finish or we jump to
   * position (+1) and jump somewhere else as well (+dfs).
   */
  class Solution {

package dp.other.multidimensional;
...
public class DiceRollSimulation {
  ...
  /**
   * The reasoning here is to check how can the ith element end. I wrote down the states for i=2 and
   * i=3.
   *
   * We use dp[n-1][a[newj]][newJ] because the state is number of combinations so for current one we
   * call other indexes dp answers and * for our index we go one by one k -1 so previously i was
   * looping through k from 1 to a[ind] that way i was repeating what was counted in *.
   */

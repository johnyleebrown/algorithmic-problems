...
public class LongestLineOfConsecutiveOneInMatrix {
  ...
  /**
   * BU solution is much nicer. So here we count 4 different results cuz we can count consecutive
   * 1's 4 diff ways. Extra element (5) is to check if we ve calculated cell before.
   */

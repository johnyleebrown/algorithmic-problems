...
public class UniquePathsII {
  ...
  public static class Solution {
    ...
    /**
     * Setting base states. previously i=0 and j=0 were 1s since we can have only 1 unique path to
     * there - base case. with obstacles thought we make sure that if we encounter 1, we can't get
     * past it, so we set other cells to 0.
     */

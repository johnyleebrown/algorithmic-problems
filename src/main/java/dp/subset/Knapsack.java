...
public class Knapsack {
	...
	/**
	 * Brute force Either we take item or not
	 */
	...
	/**
	 * Improved Backtracking+Memo In each iteration either we take the item or not
	 */
	 ...
	 * Bottom-Up, Iterative
	 *
	 * Its clear now what kind of recurrent relation is it, either we take the current item or not. We
	 * have 2 parameters: filledCapacity and currentIndex Subproblem is: what is the max profit for
	 * items[0..currentIndex] for capacity[1..filledCapacity]
	 */

...
public class PrintHeirarchy {
     ...
     *
     * 0 Create graph (has outgoing vertices and ingoing, we use ingoing for
     * topsort and
     * then to print we use outgoing)
     * 1 Check for cycles
     * 2 Find root with topsort
     * 3 Print all
     */
    public static class Solution {
        ...
        private void dfs2(String v, Map<String, List<String>[]> g, int level, Set<String> dfs2Seen) {
        ...
        private boolean hasCycle(String v, Map<String, List<String>[]> g, Set<String> globalSeen, Set<String> localSeen) {

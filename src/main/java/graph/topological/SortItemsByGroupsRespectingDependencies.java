...
public class SortItemsByGroupsRespectingDependencies {
  ...
  /**
   * Sort groups, then while sorting items, put them into places of sorted groups.
   */
  class Solution {

    private int groupsTotalSize, sortGroupsCount;
    private Map<Integer, List<Integer>> groups = new HashMap<>(), groupsWithItems = new HashMap<>(), items = new HashMap<>();

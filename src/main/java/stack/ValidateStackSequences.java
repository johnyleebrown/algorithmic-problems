...
public class ValidateStackSequences {
	...
	/**
	 * We go through the popped and try to find it in pushed. While going through pushed we
	 * collect
	 * items in the list. Our cur item can be either last in the collected list or can be
	 * somewhere
	 * ahead in the pushed array - so we go look for it. If none of those - we return
	 * false.
	 */

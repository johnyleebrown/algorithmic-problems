 ...
 * among any node in the entire tree. The subtree of a node is that node, plus
 * the set of all descendants of that node. Return the node with the largest
 * depth such that it contains all the deepest nodes in it's subtree.
 *

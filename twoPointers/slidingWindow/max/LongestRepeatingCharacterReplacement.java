...
class Solution
{
	 ...
	 * length of the entire string - number of times of the maximum 
	 * occurring character in the string. We want to find max(end - start + 1) 
	 * when (end - start + 1) - maxNumberOfSameChars <= k.
	 */
